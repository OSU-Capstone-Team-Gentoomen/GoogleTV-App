...
public class ResumeContentProvider extends ContentProvider {
		...
		public static final String CONTENT_TYPE = 
				ContentResolver.CURSOR_DIR_BASE_TYPE  + "/resume";
		
		public static final String CONTENT_ITEM_TYPE = 
				ContentResolver.CURSOR_ITEM_BASE_TYPE + "/resume_item";
		...
		private static final String CREATE_TABLE_RESUME = 
	...
	public boolean onCreate() {
		...
		DatabaseHelper helper 
			= new DatabaseHelper(context, DB_NAME, null, DB_VERSION, CREATE_TABLE_RESUME, TABLE_RESUME);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		case RESUME:
			...
			rowsUpdated = mDB.update(TABLE_RESUME, 
					values, 
					selection, 
					selectionArgs);
			break;			
