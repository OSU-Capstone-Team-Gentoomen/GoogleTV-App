...
public class FileListFragment extends ListFragment implements
	...
	static final String[] SUMMARY_PROJECTION = new String[] { "_ID", "name",
			"path", "type", };
	...
	public Loader<Cursor> onCreateLoader(int id, Bundle args) {
		...
		Log.d(LOG_TAG,
				"onCreate DeviceNavigator.Path: " + DeviceNavigator.getPath());

		setListShownNoAnimation(false);
		return new CursorLoader(getActivity(), uri, SUMMARY_PROJECTION,
				selectedFile, null, "");
	}
