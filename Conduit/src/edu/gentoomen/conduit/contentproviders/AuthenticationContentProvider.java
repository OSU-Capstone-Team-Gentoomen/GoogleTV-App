...
public class AuthenticationContentProvider extends ContentProvider {
	...
	public boolean onCreate() {
		...
		DatabaseHelper helper = new DatabaseHelper(context, DB_NAME, null,
				DB_VERSION, CREATE_TABLE_CREDENTIALS, TABLE_CREDENTIALS);
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		switch (mUriMatcher.match(uri)) {
		case CREDENTIAL_ID:
			rowsUpdated = mDB.update(TABLE_CREDENTIALS, values, selection,
					selectionArgs);
			break;
		case CREDENTIAL:
			break;
	...
	private void checkColumns(String[] projection) {
		...
		String[] avail = { ID, COL_MAC, COL_USER, COL_PASSWORD, COL_SERVICE };
